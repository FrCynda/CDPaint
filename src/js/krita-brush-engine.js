(function (app) {
    ...
    function _renderBristleDabs(x, y, pressure, colorHex, strokeAngle) {
        ...
        for (var i = 0; i < count; i++) {
            ...
            _paintDab(_flowCtx, bcx, bcy, bMask, finalColor,
                _clamp(bAlpha, 0, 1), p.texture, p.textureScale, p.textureType);
    ...
    engine.PRESETS = {
        /* ---- Pencils ---------------------------------------------------- */
        'Pencil HB': { size: 4, opacity: 100, flow: 85, spacing: 6, hardness: 65, shape: 'circle', texture: 45, textureScale: 2, textureType: 'grain', aspectRatio: 1.4, angle: 40, sizeMin: 65, flowMin: 25 },
        'Pencil 2B': { size: 6, opacity: 100, flow: 90, spacing: 6, hardness: 45, shape: 'circle', texture: 60, textureScale: 2, textureType: 'grain', aspectRatio: 1.6, angle: 40, sizeMin: 55, flowMin: 15 },
        'Pencil 6B': { size: 10, opacity: 100, flow: 100, spacing: 7, hardness: 30, shape: 'circle', texture: 70, textureScale: 3, textureType: 'chalk', aspectRatio: 1.8, angle: 40, sizeMin: 40, flowMin: 10 },
        ...
        'Graphite Shader': { size: 22, opacity: 70, flow: 35, spacing: 10, hardness: 20, shape: 'circle', texture: 65, textureScale: 4, textureType: 'grain', aspectRatio: 3, angle: 35, sizeMin: 70, flowMin: 5 },
        ...
        'Calligraphy Flat': { size: 18, opacity: 100, flow: 100, spacing: 6, hardness: 90, shape: 'square', angle: 30, aspectRatio: 6, sizeMin: 70 },
        'Brush Pen': { size: 13, opacity: 100, flow: 100, spacing: 6, hardness: 75, shape: 'circle', taperStart: 30, taperEnd: 40, sizeMin: 8, sizeCurve: 1.8, angleSrc: 'direction', aspectRatio: 1.3 },

        /* ---- Markers ----------------------------------------------------- */
        'Marker': { size: 16, opacity: 80, flow: 100, spacing: 15, hardness: 100, shape: 'square' },
        'Marker Chisel': { size: 20, opacity: 75, flow: 100, spacing: 4, hardness: 100, shape: 'square', angle: 40, aspectRatio: 2.5, sizeSrc: 'none', flowSrc: 'none' },
        'Marker Fine': { size: 6, opacity: 85, flow: 100, spacing: 4, hardness: 100, shape: 'circle', sizeSrc: 'none', flowSrc: 'none' },
        'Highlighter': { size: 26, opacity: 35, flow: 100, spacing: 3, hardness: 100, shape: 'square', aspectRatio: 3, angle: 0, sizeSrc: 'none', flowSrc: 'none' },
        'Copic Soft': { size: 22, opacity: 45, flow: 60, spacing: 5, hardness: 55, shape: 'circle', sizeSrc: 'none', flowMin: 60 },

        /* ---- Paint ------------------------------------------------------- */
        'Oil Round': { size: 20, opacity: 100, flow: 90, spacing: 8, hardness: 55, shape: 'circle', bristleCount: 9, bristleSpread: 25, texture: 25, textureScale: 3, textureType: 'canvas', sizeMin: 55 },
        'Oil Flat': { size: 26, opacity: 100, flow: 85, spacing: 7, hardness: 60, shape: 'circle', aspectRatio: 3, angleSrc: 'direction', bristleCount: 11, bristleSpread: 70, texture: 30, textureScale: 3, textureType: 'canvas' },
        'Impasto': { size: 30, opacity: 100, flow: 100, spacing: 9, hardness: 70, shape: 'circle', bristleCount: 14, bristleSpread: 55, texture: 45, textureScale: 4, textureType: 'canvas', sizeMin: 60, taperStart: 5 },
        ...
        'Acrylic Dry': { size: 22, opacity: 95, flow: 80, spacing: 12, hardness: 65, shape: 'circle', bristleCount: 10, bristleSpread: 45, texture: 70, textureScale: 2, textureType: 'canvas', hardnessSrc: 'pressure', hardnessMin: 40 },
        ...
        'Bristle Blender': { size: 28, opacity: 40, flow: 25, spacing: 8, hardness: 25, shape: 'circle', bristleCount: 16, bristleSpread: 80, flowMin: 10 },
        ...
        'Charcoal Stick': { size: 26, opacity: 100, flow: 95, spacing: 7, hardness: 35, shape: 'square', aspectRatio: 2.5, angleSrc: 'direction', texture: 85, textureScale: 3, textureType: 'chalk', sizeMin: 50 },
        'Conte': { size: 16, opacity: 95, flow: 85, spacing: 8, hardness: 50, shape: 'square', aspectRatio: 2, angle: 45, texture: 70, textureScale: 2, textureType: 'chalk' },
        ...
        'Crosshatch': { size: 20, opacity: 100, flow: 90, spacing: 10, hardness: 80, shape: 'circle', texture: 85, textureScale: 2, textureType: 'hatch', aspectRatio: 1.5, angleSrc: 'direction' },
        ...
        'Confetti': { size: 10, opacity: 100, flow: 100, spacing: 40, hardness: 100, shape: 'square', scatter: 26, angleSrc: 'random', sizeSrc: 'random', sizeMin: 30, aspectRatio: 1.6 },
