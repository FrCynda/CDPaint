(function (app) {
    ...
    engine.PRESET_CATEGORIES = [
        ...
        { name: 'Bristle',  presets: ['Fan Brush', 'Dry Brush', 'Oil Round', 'Oil Flat', 'Impasto', 'Bristle Blender'] },
        { name: 'Airbrush', presets: ['Airbrush'] },
        { name: 'Texture',  presets: ['Charcoal Rock', 'Chaotic Irregular', 'Dry Scratch', 'Sponge', 'Noise Texture', 'Chisel Streaks', 'Scribbles'] },
        { name: 'Smudge',   presets: ['Wet Modeling', 'Smudge'] },
