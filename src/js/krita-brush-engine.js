(function (app) {
    ...
    function _applyTextureNoise(ctx, w, h, textureLevel, textureScale, textureType) {
        if (textureLevel <= 0) return;
        var tile = _texTile(textureType);
    ...
    function _paintDab(destCtx, x, y, maskCanvas, colorHex, alpha, texture, textureScale, textureType) {
        var mw = maskCanvas.width;
        var mh = maskCanvas.height;
        var ox = x - mw / 2;
        var oy = y - mh / 2;
        ...
        if (texture > 0) {
            _applyTextureNoise(_scratchCtx, mw, mh, texture, textureScale, textureType);
        }
    ...
    function _renderBristleDabs(x, y, pressure, colorHex, strokeAngle, tfSize, tfInk) {
        ...
        if (p.colorRate >= 100) {
            ...
            _paintDab(_flowCtx, x, y, fan, colorHex,
                _clamp(baseAlpha, 0, 1), p.texture, p.textureScale, p.textureType);
            return;
        }
        ...
        for (var i = 0; i < lay.list.length; i++) {
            ...
            _paintDab(_flowCtx, bcx, bcy, bMask, finalColor,
                ...
                p.texture, p.textureScale, p.textureType);
        }
    }
    ...
    engine.PRESETS = {
        /* ---- Pencils ---------------------------------------------------- */
        'Pencil HB': { size: 4, opacity: 100, flow: 85, spacing: 6, hardness: 65, shape: 'circle', texture: 45, textureScale: 2, textureType: 'grain', aspectRatio: 1.4, angle: 130, sizeMin: 65, flowMin: 25 },
        'Pencil 2B': { size: 6, opacity: 100, flow: 90, spacing: 6, hardness: 45, shape: 'circle', texture: 60, textureScale: 2, textureType: 'grain', aspectRatio: 1.6, angle: 130, sizeMin: 55, flowMin: 15 },
        'Pencil 6B': { size: 10, opacity: 100, flow: 100, spacing: 7, hardness: 30, shape: 'circle', texture: 70, textureScale: 3, textureType: 'chalk', aspectRatio: 1.8, angle: 130, sizeMin: 40, flowMin: 10 },
        'Mechanical Pencil': { size: 2, opacity: 100, flow: 100, spacing: 5, hardness: 85, shape: 'circle', texture: 20, textureScale: 1, textureType: 'grain', sizeMin: 85, flowMin: 55 },
        'Colored Pencil': { size: 5, opacity: 90, flow: 70, spacing: 6, hardness: 55, shape: 'circle', texture: 55, textureScale: 2, textureType: 'canvas', sizeMin: 70, flowMin: 20 },
        'Pencil Rough': { size: 8, opacity: 100, flow: 80, spacing: 9, hardness: 40, shape: 'circle', texture: 80, textureScale: 3, textureType: 'chalk', scatter: 2, sizeMin: 45, flowMin: 10 },
        'Graphite Shader': { size: 22, opacity: 70, flow: 35, spacing: 10, hardness: 20, shape: 'circle', texture: 65, textureScale: 4, textureType: 'grain', aspectRatio: 3, angle: 125, sizeMin: 70, flowMin: 5 },

        /* ---- Inks -------------------------------------------------------- */
        'Ink': { size: 10, opacity: 100, flow: 100, spacing: 8, hardness: 70, shape: 'circle', taperStart: 20, taperEnd: 20, texture: 40, textureScale: 2 },
        'Ink Liner': { size: 3, opacity: 100, flow: 100, spacing: 5, hardness: 95, shape: 'circle', sizeSrc: 'none', flowMin: 100 },
        'Ink Brush': { size: 16, opacity: 100, flow: 100, spacing: 6, hardness: 80, shape: 'circle', taperStart: 35, taperEnd: 45, sizeMin: 12, sizeCurve: 1.6, flowMin: 60 },
        'Ink G-Pen': { size: 8, opacity: 100, flow: 100, spacing: 5, hardness: 90, shape: 'circle', taperStart: 25, taperEnd: 30, sizeMin: 20, sizeCurve: 1.4, flowMin: 80 },
        'Ink Rough': { size: 9, opacity: 100, flow: 100, spacing: 8, hardness: 70, shape: 'circle', texture: 70, textureScale: 2, textureType: 'hatch', taperStart: 15, taperEnd: 20, sizeMin: 35 },
        'Technical Pen': { size: 2, opacity: 100, flow: 100, spacing: 4, hardness: 100, shape: 'circle', sizeSrc: 'none', flowSrc: 'none' },
        'Calligraphy': { size: 14, opacity: 100, flow: 100, spacing: 10, hardness: 60, shape: 'circle', angle: 135, aspectRatio: 4, taperStart: 10, taperEnd: 10 },
        'Calligraphy Flat': { size: 18, opacity: 100, flow: 100, spacing: 6, hardness: 90, shape: 'square', angle: 120, aspectRatio: 6, sizeMin: 70 },
        'Brush Pen': { size: 13, opacity: 100, flow: 100, spacing: 6, hardness: 75, shape: 'circle', taperStart: 30, taperEnd: 40, sizeMin: 8, sizeCurve: 1.8, angleSrc: 'direction', aspectRatio: 1.3, angle: 90 },

        /* ---- Markers ----------------------------------------------------- */
        'Marker': { size: 16, opacity: 80, flow: 100, spacing: 15, hardness: 100, shape: 'square' },
        'Marker Chisel': { size: 20, opacity: 75, flow: 100, spacing: 4, hardness: 100, shape: 'square', angle: 130, aspectRatio: 2.5, sizeSrc: 'none', flowSrc: 'none' },
        'Marker Fine': { size: 6, opacity: 85, flow: 100, spacing: 4, hardness: 100, shape: 'circle', sizeSrc: 'none', flowSrc: 'none' },
        'Highlighter': { size: 26, opacity: 35, flow: 100, spacing: 3, hardness: 100, shape: 'square', aspectRatio: 3, angle: 90, sizeSrc: 'none', flowSrc: 'none' },
        ...
        'Acrylic Flat': { size: 24, opacity: 100, flow: 100, spacing: 6, hardness: 85, shape: 'square', aspectRatio: 3.5, angle: 90, angleSrc: 'direction', sizeMin: 75 },
        ...
        'Palette Knife': { size: 34, opacity: 100, flow: 100, spacing: 4, hardness: 100, shape: 'square', aspectRatio: 5, angle: 90, angleSrc: 'direction', sizeSrc: 'none', flowMin: 70 },
        ...
        'Watercolor Wet': { size: 34, opacity: 55, flow: 18, spacing: 6, hardness: 8, shape: 'circle', scatter: 5, texture: 15, textureScale: 5, flowMin: 25, sizeMin: 65 },
        'Watercolor Dry Edge': { size: 26, opacity: 85, flow: 35, spacing: 10, hardness: 45, shape: 'circle', texture: 55, textureScale: 3, textureType: 'canvas', scatter: 4, hardnessSrc: 'speed', hardnessMin: 55 },
        'Wash': { size: 46, opacity: 30, flow: 12, spacing: 5, hardness: 5, shape: 'circle', sizeSrc: 'none', flowMin: 40 },
        'Watercolor Bloom': { size: 30, opacity: 60, flow: 22, spacing: 18, hardness: 20, shape: 'circle', scatter: 16, scatterSrc: 'pressure', scatterMin: 20, texture: 25, textureScale: 4 },

        /* ---- Airbrush ---------------------------------------------------- */
        'Airbrush': { size: 22, opacity: 60, flow: 30, spacing: 10, hardness: 10, shape: 'circle', scatter: 8, airbrushMode: true, airbrushRate: 40 },
        'Airbrush Soft': { size: 42, opacity: 40, flow: 10, spacing: 6, hardness: 0, shape: 'circle', airbrushMode: true, airbrushRate: 55, flowMin: 20 },
        'Airbrush Hard': { size: 16, opacity: 90, flow: 55, spacing: 6, hardness: 45, shape: 'circle', airbrushMode: true, airbrushRate: 35, sizeMin: 70 },
        'Spray Can': { size: 30, opacity: 70, flow: 22, spacing: 8, hardness: 18, shape: 'circle', scatter: 20, texture: 45, textureScale: 3, textureType: 'spray', airbrushMode: true, airbrushRate: 50 },
        'Speckle Spray': { size: 24, opacity: 100, flow: 100, spacing: 14, hardness: 90, shape: 'circle', scatter: 26, texture: 65, textureScale: 2, textureType: 'spray', sizeSrc: 'random', sizeMin: 20 },

        /* ---- Texture and grunge ------------------------------------------ */
        'Charcoal': { size: 18, opacity: 90, flow: 100, spacing: 10, hardness: 40, shape: 'circle', texture: 75, textureScale: 3, scatter: 4, angle: 105, aspectRatio: 2 },
        'Charcoal Stick': { size: 26, opacity: 100, flow: 95, spacing: 7, hardness: 35, shape: 'square', aspectRatio: 2.5, angle: 90, angleSrc: 'direction', texture: 85, textureScale: 3, textureType: 'chalk', sizeMin: 50 },
        'Conte': { size: 16, opacity: 95, flow: 85, spacing: 8, hardness: 50, shape: 'square', aspectRatio: 2, angle: 135, texture: 70, textureScale: 2, textureType: 'chalk' },
        'Canvas Grain': { size: 24, opacity: 85, flow: 70, spacing: 9, hardness: 60, shape: 'circle', texture: 90, textureScale: 3, textureType: 'canvas', sizeMin: 60 },
        'Crosshatch': { size: 20, opacity: 100, flow: 90, spacing: 10, hardness: 80, shape: 'circle', texture: 85, textureScale: 2, textureType: 'hatch', aspectRatio: 1.5, angle: 90, angleSrc: 'direction' },
        ...
        /* ---- Surfaces ---------------------------------------------------- */
        'Pencil on Paper': { size: 7, opacity: 100, flow: 90, spacing: 6, hardness: 45, shape: 'circle', aspectRatio: 1.6, angle: 130, dualTip: 'canvas', dualScale: 2, dualDepth: 65, sizeMin: 55, flowMin: 15 },
        'Charcoal on Paper': { size: 24, opacity: 100, flow: 95, spacing: 7, hardness: 35, shape: 'square', aspectRatio: 2.5, angle: 90, angleSrc: 'direction', dualTip: 'chalk', dualScale: 3, dualDepth: 85, sizeMin: 50 },
        'Chalk on Board': { size: 20, opacity: 95, flow: 100, spacing: 8, hardness: 55, shape: 'circle', dualTip: 'chalk', dualScale: 5, dualDepth: 90 },
        'Pastel on Tooth': { size: 22, opacity: 90, flow: 80, spacing: 7, hardness: 40, shape: 'circle', aspectRatio: 1.8, angle: 120, dualTip: 'hatch', dualScale: 2, dualDepth: 70, sizeMin: 60 },
        ...
        'Acrylic on Canvas': { size: 26, opacity: 100, flow: 100, spacing: 6, hardness: 85, shape: 'square', aspectRatio: 3, angle: 90, angleSrc: 'direction', dualTip: 'canvas', dualScale: 3, dualDepth: 80, sizeMin: 70 },
        ...
        'Confetti': { size: 10, opacity: 100, flow: 100, spacing: 40, hardness: 100, shape: 'square', scatter: 26, angleSrc: 'random', sizeSrc: 'random', sizeMin: 30, aspectRatio: 1.6, angle: 90 },
    ...
    engine.PRESET_CATEGORIES = [
        { name: 'Pencils',  presets: ['Pencil HB', 'Pencil 2B', 'Pencil 6B', 'Mechanical Pencil', 'Colored Pencil', 'Pencil Rough', 'Graphite Shader'] },
        { name: 'Inks',     presets: ['Ink', 'Ink Liner', 'Ink Brush', 'Ink G-Pen', 'Ink Rough', 'Technical Pen', 'Calligraphy', 'Calligraphy Flat', 'Brush Pen'] },
        { name: 'Markers',  presets: ['Marker', 'Marker Chisel', 'Marker Fine', 'Highlighter', 'Copic Soft'] },
        { name: 'Paint',    presets: ['Oil Round', 'Oil Flat', 'Impasto', 'Acrylic Flat', 'Acrylic Dry', 'Palette Knife', 'Fan Brush', 'Dry Brush', 'Bristle Blender', 'Impressionist'] },
